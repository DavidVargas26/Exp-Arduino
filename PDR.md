...
El proposito general de esta experiencia seria dar a entender a los estudiantes de grados menores como funciona un arduino de forma facil y llamativa, para que entiendan de una forma sencilla como usarlo. esperar usarlo en aulas de clase para que los niños puedan experimentar y entender desde temprana edad el funcionamiento de un arduino.

---

## 3. Público y contexto de uso

El publico al que seria dirigido seria mas a estudiantes pequeños para que puedan entender de forma sencilla y interactiva el uso del arduino, de esa manera tambien integrarlos a el procedimiento de la experiencia con un arduino, estaria enfocado a salones de clase de colegiocon estudiantepequeños entre 7 y 10 años.

---

## 4. Idea creativa

Mi idea es hacer una clase de experiencia que haga que cuando el microfono detecte sonido o un cambio salte el avatar, y con el acelerometro conforme se incline a un lado a otro se mueva de izquierda a derecha, que hayan obstaculos y tenga que llegar a una meta final, el joystick serviria para mover un poco la camara hacia los lados, para que pueda ver que obstaculos abran mas adelante.con el fotometro si lo cubren el ambiente se volveria de noche y si lo descubren se volveria de dia.
---